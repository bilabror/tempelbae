          ...
          <div class="row">
            ...
            <div class="col-4 align-self-center">
              <div class="icon-info text-right">
                <i class="dripicons-link bg-soft-warning"></i>
              </div>
            </div>
            <!--end col-->
          </div>
      ...
      <div class="card">
        <div class="card-body mb-0">
          <div class="row">
            <div class="col-8 align-self-center">
              <div class="">
                <h4 class="mt-0 header-title">Total User</h4>
                <h2 class="mt-0 font-weight-bold text-dark">200</h2>
                <p class="mb-0 text-muted">
                  <span class="text-success"><i class="mdi mdi-arrow-up"></i></span> Up from yesterday
                </p>
              </div>
            </div>
            <!--end col-->
            <div class="col-4 align-self-center">
              <div class="icon-info text-right">
                <i class="dripicons-user bg-soft-success"></i>
              </div>
            </div>
            <!--end col-->
          </div>
